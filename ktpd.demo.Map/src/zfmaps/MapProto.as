package zfmaps
{
	...
	import zfmaps.auxiliarys.BarrierOpened;
	import zfmaps.auxiliarys.GateOpened;
	import zfmaps.auxiliarys.MapUtil;
	import zfmaps.npcs.MapNpcs;
	import zfmaps.players.GlobalPlayers;
	import zfmaps.players.MapPlayers;
	...
	public class MapProto
	{
		...
		public function MapProto(singleton : Singleton)
		{
			...
			MapSignals.sendTransportTo.add(cs_transport);
			sToC();
		}
		...
		{
			MapSignals.receiveMapInfoStart.dispatch();
			GateOpened.clear();
			BarrierOpened.clear();
			var i : int;
		...
		{
			mapPlayers.playerLeave(msg.playerId);
		}
		...
		{
			mapPlayers.sc_playerTransport(msg);
		}
		...
		/** 0x22 使用传送点 */
		public function useGateChangeMap(gateId : int) : void
		{
