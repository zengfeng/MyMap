package zfmaps.auxiliarys
{
	...
	import zfmaps.configs.MapConfig;
	import zfmaps.configs.MapConfigData;
	import zfmaps.configs.MapId;
	import zfmaps.configs.structs.GateStruct;
	...
	public class MapUtil
	{
		...
		public static var stageWidthHalf : int;
		public static var stageHeightHalf : int;
		public static var mapWidth : int;
		public static var mapHeight : int;
		public static var selfX:int;
		public static var selfY:int;
		...
		public static function setSelfPosition(x:int, y:int):void
		{
			selfX = x;
			selfY = y;
		}
		...
		public static function getMapStruct(mapId : uint = 0) : MapStruct
		{
			...
			if (mapId <= 0)
			{
				...
				if (mapStruct == null) mapStruct = mapConfigData.getMapStruct(MapStartup.loginMapId);
			}
			else
			{
