package zfmaps.layers.lands
{
	import flash.utils.getTimer;
	import zfmaps.MapSignals;
	import zfmaps.auxiliarys.PointShape;
	import zfmaps.configs.LandConfig;
	import zfmaps.grids.ConstantSizeGenerateGrid;
	import zfmaps.grids.Grid;
	import zfmaps.grids.GridItem;
	import zfmaps.layers.lands.pools.BitmapDataPool;
	import zfmaps.layers.lands.pools.BitmapPool;
	...
	public class LandLayer extends Sprite
	{
		...
		{
			MapSignals.mouseWalkTo.dispatch(this.mouseX, this.mouseY);
		}
