package zfmaps.loads
{
	...
	public class LoadManager
	{
		...
		public var signalPieceComplete : Signal;
		...
		function LoadManager(singleton : Singleton)
		{
			...
			signalProgress = new Signal(int/** 已加载的 */, int/** 总数 */);
			signalComplete = new Signal();
			signalPieceComplete = new Signal();
		}
